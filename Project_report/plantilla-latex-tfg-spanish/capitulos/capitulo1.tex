...
\begin{itemize}
    ...
    Por otro lado, implica también la configuración segura del sistema, como deshabilitar servicios innecesarios o cerrar puertos no utilizados.
...
Tomando como referencia esta base tecnológica de sistemas y el complejo panorama de la ciberseguridad descrito, el presente proyecto propone el diseño y desarrollo de un sistema de reporte seguro para entornos \textit{Linux}, con un enfoque especial en la protección frente a \textbf{\textit{rootkits}}.
A lo largo de los próximos apartados se profundizará en la naturaleza y el funcionamiento interno de estas amenazas avanzadas, para posteriormente detallar la arquitectura, diseño y validación de una solución técnica capaz de evitar la manipulación de datos críticos y garantizar su veracidad.
...
Como se mencionó en la introducción de la memoria, un \textit{rootkit} es un tipo de \textit{malware} diseñado para ocultar y manipular recursos del sistema, como procesos, ficheros, conexiones de red o mecanismos de persistencia.
...
\begin{figure}[h!]
  \centering
  \scalebox{0.9}{\input{figs/rootkits_types.tex}}

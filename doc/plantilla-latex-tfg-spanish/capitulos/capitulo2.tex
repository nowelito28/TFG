...
La \textit{Raspberry Pi} se emplea como plataforma experimental controlada, portable y adecuada para las pruebas, pero las ideas desarrolladas se apoyan en interfaces y mecanismos propios de \textit{Linux}, por lo que podrían trasladarse a otros sistemas compatibles con las adaptaciones necesarias al \textit{nernel}, la arquitectura y el entorno de compilación.\\

...
\begin{tikzpicture}[
  ...
  \path[use as bounding box] (0,0) rectangle (15.1,6.05);
  ...
  \draw[block] (0.45,3.95) rectangle (1.65,4.45);
  \node[label] at (1.05,4.20) {\(M_1\)\\512 bits};
  \node[label] at (1.92,4.20) {+};
  \draw[block] (2.20,3.95) rectangle (3.40,4.45);
  \node[label] at (2.80,4.20) {\(M_2\)\\512 bits};
  \node[label] at (3.67,4.20) {+};
  \node[label] at (4.02,4.20) {...};
  \node[label] at (4.37,4.20) {+};
  \draw[block] (4.65,3.95) rectangle (5.85,4.45);

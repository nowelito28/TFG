...
\begin{tikzpicture}[
  ...
  smalllabel/.style={font=\sffamily\fontsize{6.7}{7.3}\selectfont, text=srtext, align=center},
  ...
  \node[text=srred] at (11.60,5.58) {\fontsize{10}{10}\selectfont \faSkullCrossbones};

  \draw[softbox] (5.85,3.10) rectangle (12.15,5.00);
  \node[title] at (9.00,4.62) {Kernel Space};
  \draw[kernelbox] (8.25,3.98) rectangle (9.75,4.46);
  \node[label] at (9.00,4.22) {LKM};
  \draw[keybox] (9.95,4.06) rectangle (10.59,4.38);
  \node[label] at (10.27,4.22) {$K$};
  \draw[flow] (9.95,4.22) -- (9.75,4.22);

  \draw[softbox] (7.78,3.20) rectangle (10.22,3.62);
  \node[smalllabel] at (9.00,3.41) {active processes table};

  \draw[kernelbox] (5.98,4.62) rectangle (7.75,5.30);
  \node[label] at (6.865,4.96) {\texttt{/proc file}};

  \draw[biflow]
    (7.58,4.62) .. controls (7.88,4.28) and (8.00,4.22) .. (8.25,4.22);
  \draw[biflow]
    (9.00,3.98) -- (9.00,3.62);
  ...
  \draw[flow]
    (7.78,3.41) .. controls (7.42,3.30) and (7.42,2.92) .. (7.78,2.85);
  \draw[flow]
    (10.22,2.85) .. controls (10.58,2.92) and (10.58,3.30) .. (10.22,3.41);
  ...
  \node[label] at (1.62,2.20) {check auth\\processes list};
  ...
  \draw[flow] (8.25,4.06) .. controls (7.05,3.20) and (5.55,3.12) .. (4.70,3.35);
  \node[label] at (6.70,3.92) {write auth\\processes list};

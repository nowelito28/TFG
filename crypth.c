  ...
  loff_t *ppos)
{
  ...
  copy_from_user(buf, ubuf, BUFSIZE); // Copiar K desde espacio de user a memoria del kernel
  ...
  // Firmar con HMAC(SHA-256) el mensaje recibido desde espacio de user (ubuf)
